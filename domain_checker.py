...
def is_domain_available(domain: str) -> bool:
    ...
    try:
        ...
        if type(e).__name__ in (
            ...
            return True
        # For other unexpected errors, we err on the side of caution
        # (assume unavailable)
...
if __name__ == "__main__":
    ...
    test_domain = "a-very-random-domain-12345.com"
    print(f"{test_domain} available? {is_domain_available(test_domain)}")
